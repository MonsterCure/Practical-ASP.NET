...
namespace ERestaurant.Web.Tests.Services
{
    ...
    public class CategoryServiceTests
    {
        ...
        public void AddCategory_ValidInput_ExpectTwoItems()
        {
            ...
            Assert.IsTrue(resultCategories.ListItems.Count >= 2); // since test method adds the same entries to the database, here we check if there are at least 2 created
        }
    }
}
